...
ConditionZ8: ;jmp $
             ...
             mov dx, 2
             test bl, al
             jnz ConditionZ8False
             add [_IP], dx
			 ret
             ConditionZ8False: add [_IP], dx
                               ConditionZ8FalseWhile:
                               movzx esi, word[_CS]
                               shl esi, 4
                               add esi, [MEM_ADDR]
                               add esi, [_IP]
                               ...
                               mov cl, [esi]
                               test cl, cl
                               jz ConditionZ8FalseReturn
                               jmp ConditionZ8FalseWhile
             ConditionZ8FalseReturn: ret
...
ConditionE8: ;jmp $
             ...
             mov dx, 2
             cmp bl, al
             jne ConditionE8False
             add [_IP], dx
			 ret
             ConditionE8False: add [_IP], dx
                               ConditionE8FalseWhile:
                               movzx esi, word[_CS]
                               shl esi, 4
                               add esi, [MEM_ADDR]
                               add esi, [_IP]
                               ...
                               mov cl, [esi]
                               test cl, cl
                               jz ConditionE8FalseReturn
                               jmp ConditionE8FalseWhile
             ConditionE8FalseReturn: ret
...
ConditionG8: ;jmp $
             ...
             mov dx, 2
             cmp bl, al
             jng ConditionZ8False
             add [_IP], dx
			 ret
             ConditionG8False: add [_IP], dx
                               ConditionG8FalseWhile:
                               movzx esi, word[_CS]
                               shl esi, 4
                               add esi, [MEM_ADDR]
                               add esi, [_IP]
                               ...
                               mov cl, [esi]
                               test cl, cl
                               jz ConditionG8FalseReturn
                               jmp ConditionG8FalseWhile
             ConditionG8FalseReturn: ret
...
ConditionL8: ;jmp $
             ...
             mov dx, 2
             cmp bl, al
             jnl ConditionL8False
             add [_IP], dx
			 ret
             ConditionL8False: add [_IP], dx
                               ConditionL8FalseWhile:
                               movzx esi, word[_CS]
                               shl esi, 4
                               add esi, [MEM_ADDR]
                               add esi, [_IP]
                               ...
                               mov cl, [esi]
                               test cl, cl
                               jz ConditionL8FalseReturn
                               jmp ConditionL8FalseWhile
             ConditionL8FalseReturn: ret
